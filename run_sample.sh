...
python inference.py --dataset scene_graphs --model_name inference_llm --llm_model_name 7b_chat --max_txt_len 0  (done)
...
python inference.py --dataset scene_graphs --model_name inference_llm --llm_model_name 7b_chat  (done)
...
python train.py --dataset scene_graphs --model_name pt_llm (done)
python train.py --dataset webqsp --model_name pt_llm  
# b) g-retriever
python train.py --dataset expla_graphs --model_name graph_llm  
python train.py --dataset scene_graphs --model_name graph_llm  (done)
...
python train.py --dataset scene_graphs --model_name graph_llm --llm_frozen False  (done)
